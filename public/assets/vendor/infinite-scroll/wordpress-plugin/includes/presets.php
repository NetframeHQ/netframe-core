...
class Infinite_Scroll_Presets_Table extends WP_List_Table {
	...
	function column_theme( $item ) {
		...
		$s = '<strong><a class="theme-name">' . $item->theme . '</a></strong>';
		...
		$s .= '<div class="save save-link" style="display:none; padding-top:5px;"><a class="button-primary">' . __( 'Save', 'infinite-scroll' ) . '</a> <a class="cancel">' . __( 'Cancel', 'infinite-scroll' ) . '</a> <img class="loader" style="display:none;" src="'. admin_url( '/images/loading.gif' ) .'" /></div>';
		return $s;
	}
