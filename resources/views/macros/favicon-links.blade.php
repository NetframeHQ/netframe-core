...
<meta name="msapplication-square70x70logo" content="{{ asset('assets/img/favicon/smalltile.png') }}" />
<meta name="msapplication-square150x150logo" content="{{ asset('assets/img/favicon/mediumtile.png') }}" />
<meta name="msapplication-wide310x150logo" content="{{ asset('assets/img/favicon/widetile.png') }}" />
<meta name="msapplication-square310x310logo" content="{{ asset('assets/img/favicon/largetile.png') }}" />
<meta name="msapplication-TileColor" content="#00a19a">
<meta name="msapplication-TileImage" content="{{ asset('assets/img/favicon/mediumtile.png') }}">
