...
h4 {
    font-size: 24px;
    border-bottom:2px #ff6c2c solid;
                                                ...
                                                <th class="small-12 large-12 columns first last">
                                                    <table>
                                                        <tr>
                                                            <th>
                                                                <br>
                                                                <a style="text-decoration:none; color:#2199e8" href="{{ (isset($instanceUrl)) ? $instanceUrl : config('app.url') }}">
                                                                    <center>
                                                                    @if(isset($instanceLogo))
                                                                        <img src="{{ $message->embed($instanceLogo) }}" alt="netframe" />
                                                                    @else
                                                                        <img src="{{ $message->embed(public_path().'/assets/img/logoMail.png') }}" alt="netframe" />
                                                                    @endif
