...
class RegisterVisitor extends Mailable
{
    ...
    public function build()
    {
        ...
        $instanceLogo = $instance->getParameter('main_logo', true);
        ...
        return $this->view('emails.visitor.register', $this->dataEmail)
            ->subject(trans('email.visitor.subject'));
    }
}
